...
# from PragyanRobot.modules.sql import warns_sql as warnssql
import PragyanRobot.modules.sql.blacklist_sql as blacklistsql

# from PragyanRobot.modules.sql import cust_filters_sql as filtersql
# import PragyanRobot.modules.sql.welcome_sql as welcsql
import PragyanRobot.modules.sql.locks_sql as locksql
import PragyanRobot.modules.sql.notes_sql as sql
...
from PragyanRobot.modules.helper_funcs.chat_status import user_admin
from PragyanRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("PragyanRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("PragyanRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `PragyanRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("PragyanRobot{}.backup".format(chat_id))  # Cleaning file
