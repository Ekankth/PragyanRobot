...
from PragyanRobot import OWNER_ID as owner_id
from PragyanRobot import PRAGYANIITIANCHAT as log,BOT_NAME,START_IMG
from PragyanRobot import pbot as Client
