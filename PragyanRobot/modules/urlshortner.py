...
@pragyan.on_message(filters.command(["short"]))
...
@pragyan.on_message(filters.command(["unshort"]))
...
# pragyan.add_handler(MessageHandler(short_urls))
# pragyan.add_handler(MessageHandler(unshort))
__help__ = """
ᴍᴀᴋᴇ sʜᴏʀᴛs ᴏғ ᴀ ɢɪᴠᴇɴ ʟɪɴᴋ 
 ❍ /short <url>  *:Example `/short https://t.me/pragyaniitian`.
 *"""
