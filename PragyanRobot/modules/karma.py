...
from PragyanRobot import OWNER_ID, pbot
from PragyanRobot.utils.admins import can_change_info
from PragyanRobot.utils.errors import capture_err
from PragyanRobot.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote = r"^((?i)\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤|💘|cool|good|👍|baby|pragyan|thank you|gud|thankyou|love|pro)$"
