...
from PragyanRobot import DRAGONS, EVENT_LOGS, EVENT_LOGS, PRAGYANIITIANCHAT, dispatcher
from PragyanRobot.modules.disable import DisableAbleCommandHandler
from PragyanRobot.modules.helper_funcs.chat_status import connection_status, user_admin
from PragyanRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from PragyanRobot.modules.helper_funcs.msg_types import get_note_type
            ...
            try:
                ...
                if excp.message == "Entity_mention_user_invalid":
                    ...
                    message.reply_text(
                        ...
                        f"@{PRAGYANIITIANCHAT} if you can't figure out why!"
                    )
