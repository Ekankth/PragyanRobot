...
from PragyanRobot import BOT_USERNAME, OWNER_ID, PRAGYANIITIANCHAT, telethn
from PragyanRobot.events import register
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./pragyanRobot/resources/fonts/*")
        ...
        await event.reply(f"ғʟᴏᴏᴅ ᴡᴀɪᴛ ᴇʀʀᴏʀ, ʀᴇᴩᴏʀᴛ ᴛʜɪs ᴀᴛ @{PRAGYANIITIANCHAT}")
