...
@pragyan.on_message(filters.command(["gps"]))
...
#     await message.delete()
    ...
    try:
        ...
        """
        ---------github :-NOOB-pragyan -----
        ---------telegram : @PragyanIITIAn-----
        """
        geolocator = Nominatim(user_agent="legend-pragyan")
#         zoom=[0-18]
...
@pragyan.on_message(filters.command(["distance"]))
...
# pragyan.add_handler(MessageHandler(gps))     
# pragyan.add_handler(MessageHandler(distance))
