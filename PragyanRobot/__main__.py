...
import PragyanRobot.modules.sql.users_sql as sql
...
from PragyanRobot.modules import ALL_MODULES
from PragyanRobot.modules.helper_funcs.chat_status import is_user_admin
from PragyanRobot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("PragyanRobot.modules." + module_name)
        ...
        if mod_match:
            ...
            query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="help_back"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="pragyan_support")]]
                ),
            )
...
def Pragyan_about_callback(update: Update, context: CallbackContext):
    query = update.callback_query
    if query.data == "pragyan_":
        uptime = get_readable_time((time.time() - StartTime))
        query.message.edit_text(text=f"*ʜᴇʏ,*🥀\n  *ᴛʜɪs ɪs {dispatcher.bot.first_name}*"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="🚩sᴜᴩᴩᴏʀᴛ🚩", callback_data="pragyan_support"
                        ),
                        InlineKeyboardButton(
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="🥀sᴏᴜʀᴄᴇ🥀",
                            url="https://github.com/PragyanIITIAN/PragyanRobot",
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="◁", callback_data="pragyan_back"),
                    ],
                ]
            ),
        )
    elif query.data == "pragyan_support":
        query.message.edit_text(text="**๏ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ʜᴇʟᴩ ᴀɴᴅ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴍᴇ.**"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="🚩sᴜᴩᴩᴏʀᴛ🚩", url=f"https://t.me/{PRAGYANIITIANCHAT}"
                        ),
                        InlineKeyboardButton(
                            text="💗ᴜᴩᴅᴀᴛᴇs💓", url=f"https://t.me/pragyanbotzone"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                        ...
                        InlineKeyboardButton(
                            text="✨ɢɪᴛʜᴜʙ✨", url="https://github.com/PragyanIITIAN"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="◁", callback_data="pragyan_"),
                    ],
                ]
            ),
        )
    elif query.data == "pragyan_back":
        first_name = update.effective_user.first_name 
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=" ʙᴀᴄᴋ ", callback_data="Music_"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="pragyan_support")
                    ]
                ]
            ),
        )
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        ...
        send_help(
            ...
            text,
            InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="◁", callback_data="help_back"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="pragyan_support")]]
            ),
        )
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 2145093972 and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [ɢɪᴛʜᴜʙ](https://github.com/PragyanIITIAN/PragyanRobot)"
...
def main():
    ...
    if PRAGYANIITIANCHAT is not None and isinstance(PRAGYANIITIANCHAT, str):
        try:
...
""",reply_markup=x,
            ...
            LOGGER.warning(
                f"Bot isn't able to send message to @{PRAGYANIITIANCHAT}, go and check!"
            )
    ...
    about_callback_handler = CallbackQueryHandler(
        pragyan_about_callback, pattern=r"pragyan_", run_async=True
    )
