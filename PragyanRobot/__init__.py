...
if ENV:
    ...
    from PragyanRobot.config import Development as Config
...
telethn = TelegramClient("pragyan", API_ID, API_HASH)

pbot = Client("PragyanRobot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from PragyanRobot.modules.helper_funcs.handlers import (
